...
# Remove circular import - areEquivalent will be available when needed
# from ltl.spotutils import areEquivalent


# Dummy ltltoeng implementation to avoid circular imports
class ltltoeng:
    @staticmethod
...
def parse_ltl_string(s):
    try:
        ...
        raise ValueError(f"Failed to parse LTL string '{s}': {e}")
